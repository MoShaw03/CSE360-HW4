	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				// the FSM goes to state 1. The first character must be alphabetic.                    //Code Changed
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after '.','-','_' must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
