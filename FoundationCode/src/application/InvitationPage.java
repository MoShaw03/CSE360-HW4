...
public class InvitationPage {
     ...
     */
    public void show(DatabaseHelper databaseHelper, User currentUser,Stage primaryStage) {
        ...
        layout.getChildren().addAll(userLabel, showCodeButton, backButton, inviteCodeLabel);
